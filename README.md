...
|[cloudrun-declerative](workflows/deploy-cloudrun/cloudrun-declerative.yml) | ✅ | Deploy to Google Cloud Run by a [declarative YAML Service specification (KRM)](https://cloud.google.com/sdk/gcloud/reference/run/services/replace).  |
